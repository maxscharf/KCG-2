...
import { createImageAtPoint } from './World/World.js';
import { scene } from './World/World.js';
...
const imageTexture = textureLoader.load('assets/textures/saul-12-1-17.png', function(texture) {
